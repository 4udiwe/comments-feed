...
import (
	...
	httpmiddleware "github.com/4udiwe/commnets-feed/internal/middleware"
	"github.com/4udiwe/commnets-feed/pkg/httpserver"
...
func (app *App) runHTTP(srv *handler.Server) {
	...
	// Применяем DataLoader middleware
